export const inputClass =
  "focus-ring min-h-11 w-full rounded-lg border border-[#d8d9d4] bg-white px-3 py-2 text-base text-ink shadow-[0_1px_1px_rgba(23,41,35,0.02)] transition placeholder:text-forest/35 hover:border-forest/30 focus:border-forest sm:text-sm";
export const labelClass = "text-xs font-medium text-forest/75";
export const buttonClass =
  "focus-ring inline-flex min-h-11 items-center justify-center gap-2 rounded-lg bg-forest px-4 py-2 text-sm font-medium text-cream transition hover:bg-forest-light disabled:cursor-not-allowed disabled:opacity-50";
