...
async function seedCatalog() {
  const catalog: Array<{
    ...
    { type: "categoria_despesa", key: "lavagem", label: "Lavagem e higienização", order: 2 },
    { type: "categoria_despesa", key: "balsa", label: "Balsa", order: 3 },
    { type: "categoria_despesa", key: "manutencao", label: "Manutenção", order: 4 },
    { type: "categoria_despesa", key: "pedagio", label: "Pedágio", order: 5 },
    { type: "categoria_despesa", key: "estacionamento", label: "Estacionamento", order: 6 },
    { type: "categoria_despesa", key: "lanche", label: "Lanche", order: 7 },
    { type: "categoria_despesa", key: "agua", label: "Água e bebidas", order: 8 },
    { type: "categoria_despesa", key: "almoco", label: "Almoço/refeição", order: 9 },
    { type: "categoria_despesa", key: "alimentacao", label: "Alimentação (outras)", order: 10 },
    { type: "categoria_despesa", key: "outro", label: "Outro", order: 99 },
